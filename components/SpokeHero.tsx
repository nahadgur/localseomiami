...
// host. Motif: concentric signal arcs + scatter dots (matches the local-SEO /
// map-pack vertical). The gradient hue is seeded by the hub slug, so every
...
const SITE_NAME = 'Local Miami SEO';

// Brand palette. Each pair is a [dark, mid] gradient; the hub hash picks one so
// hubs differ but stay on-brand.
...
export function SpokeHero({
  ...
  return (
    ...
    >
      ...
      <g fill="none" stroke="#ffffff" strokeOpacity="0.22" strokeWidth="3"><path d="M860 340 A 140 140 0 0 1 1100 200"/><path d="M820 340 A 200 200 0 0 1 1100 140"/><path d="M780 340 A 260 260 0 0 1 1100 80"/></g><g fill="#ffffff" fillOpacity="0.5"><circle cx="120" cy="70" r="4"/><circle cx="170" cy="60" r="3"/><circle cx="90" cy="100" r="3"/></g>
